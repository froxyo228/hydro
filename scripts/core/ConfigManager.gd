# ========== ConfigManager.gd ==========
# Менеджер конфигурации - управляет настройками игры и их сохранением
extends Node
...
## Применить все настройки к системе
func apply_settings():
...
## Применить одну конкретную настройку
...
## Получить экземпляр синглтона (статический метод)
